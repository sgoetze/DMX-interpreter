...
#define COMPRESSEDSAVE "input area compressed ("
#define COMPRESSEDSAVE2 " byte) saved to File "
#define FULLSAVE1 "input area completely (
#define FULLSAVE2 " byte) saved to File "
#define SAVETOOBIG "program in input area too big"
#define PROGLENGTH "length of program: "
